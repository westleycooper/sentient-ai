 ...
 * title slot defaults to the "Sentient" wordmark; pass `titleContent` to
...
interface AppHeaderProps {
  ...
  /**
   * Replaces the "Sentient" title (e.g. HomePage's SME selector). Pass
  ...
  return (
    <AppBar position="static" color="transparent" elevation={0} sx={{ flexShrink: 0 }}>
      <Toolbar variant="dense" disableGutters>
        ...
        <Tooltip title="Why Sentient — features, themes, and licence">
          <IconButton onClick={() => navigate("/showcase")} aria-label="About Sentient">
            <AutoAwesomeIcon />
          </IconButton>
        </Tooltip>
